...
[![Merge to Main](https://github.com/bcgov-nr/vault/actions/workflows/merge-main.yml/badge.svg)](https://github.com/bcgov-nr/vault/actions/workflows/merge-main.yml)
[![Unit Tests and Analysis](https://github.com/bcgov-nr/vault/actions/workflows/unit-tests.yml/badge.svg)](https://github.com/bcgov-nr/vault/actions/workflows/unit-tests.yml)

[![Issues](https://img.shields.io/github/issues/bcgov-nr/vault)](/../../issues)
[![Pull Requests](https://img.shields.io/github/issues-pr/bcgov-nr/vault)](/../../pulls)
[![MIT License](https://img.shields.io/github/license/bcgov-nr/vault.svg)](/LICENSE.md)
[![Lifecycle](https://img.shields.io/badge/Lifecycle-Experimental-339999)](https://github.com/bcgov/repomountie/blob/master/doc/lifecycle-badges.md)

# QuickStart: OpenShift, TypeScript and Postgres/PostGIS

The DevOps Quickstart is a fully functional set of pipeline workflows and a starter application stack intended to help Agile DevOps teams hit the ground running.  Currently OpenShift is supported with plans for AWS (Amazon Web Services).  Pipelines are run using [GitHub Actions](https://github.com/bcgov-nr/vault/actions).
...
* Select bcgov-nr/vault under Repository template
...
E.g. https://github.com/bcgov-nr/vault/packages
